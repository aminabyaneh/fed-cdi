...
class Experiment:
    ...
    def run(self):
        ...
        np.savetxt(os.path.join(self.a.dump_dir, "nodeArities.csv"),
                   arity.numpy(),   fmt="%d", delimiter=",")
        np.savetxt(os.path.join(self.a.dump_dir, "dag.csv"),
                   dag.numpy(),     fmt="%d", delimiter=",")
        np.savetxt(os.path.join(self.a.dump_dir, "samples.csv"),
                   samples.numpy(), fmt="%d", delimiter=",")
        np.savetxt(os.path.join(self.a.dump_dir, "clampedMask.csv"),
